...
#pragma warning disable 0169
		...
		{
			if (cb_onPreviewFrame_OnPreviewFrame_Landroid_graphics_Bitmap__V == null)
				cb_onPreviewFrame_OnPreviewFrame_Landroid_graphics_Bitmap__V = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPL_V (n_OnPreviewFrame_Landroid_graphics_Bitmap_));
			return cb_onPreviewFrame_OnPreviewFrame_Landroid_graphics_Bitmap__V;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_onCameraClosed_OnCameraClosed_V == null)
				cb_onCameraClosed_OnCameraClosed_V = JNINativeWrapper.CreateDelegate (new _JniMarshal_PP_V (n_OnCameraClosed));
			return cb_onCameraClosed_OnCameraClosed_V;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_onCameraError_OnCameraError_Ljava_lang_String__V == null)
				cb_onCameraError_OnCameraError_Ljava_lang_String__V = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPL_V (n_OnCameraError_Ljava_lang_String_));
			return cb_onCameraError_OnCameraError_Ljava_lang_String__V;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_onCameraOpened_OnCameraOpened_V == null)
				cb_onCameraOpened_OnCameraOpened_V = JNINativeWrapper.CreateDelegate (new _JniMarshal_PP_V (n_OnCameraOpened));
			return cb_onCameraOpened_OnCameraOpened_V;
		}
...
#pragma warning disable 0169
		...
		{
			if (cb_onPhotoCaptured_OnPhotoCaptured_Landroid_graphics_Bitmap__V == null)
				cb_onPhotoCaptured_OnPhotoCaptured_Landroid_graphics_Bitmap__V = JNINativeWrapper.CreateDelegate (new _JniMarshal_PPL_V (n_OnPhotoCaptured_Landroid_graphics_Bitmap_));
			return cb_onPhotoCaptured_OnPhotoCaptured_Landroid_graphics_Bitmap__V;
		}
