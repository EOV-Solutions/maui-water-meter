...
namespace WaterMeter.Maui.Platforms.iOS {
	...
	/// <summary>This interface represents the Objective-C protocol <c>_TtP13WaterMeterSDK28WMCameraScannerDelegate_ObjC_</c>.</summary>
	/// <remarks>
...
namespace WaterMeter.Maui.Platforms.iOS {
	/// <summary>
	///   <para>This is a class that implements the interface <see cref="IWMCameraScannerDelegateObjC" /> (for the protocol <c>_TtP13WaterMeterSDK28WMCameraScannerDelegate_ObjC_</c>).</para>
