...
namespace WaterMeter.Maui.Platforms.iOS {
	...
	/// <summary>This interface represents the Objective-C protocol <c>WMCameraScannerDelegateObjC</c>.</summary>
	/// <remarks>
	///   <para>A class that implements this interface (and subclasses <see cref="NSObject" />) will be exported to Objective-C as implementing the Objective-C protocol this interface represents.</para>
	///   <para>A class may also implement members from this interface to implement members from the protocol.</para>
	/// </remarks>
	[Protocol (Name = "WMCameraScannerDelegateObjC", WrapperType = typeof (WMCameraScannerDelegateObjCWrapper))]
	...
	#pragma warning disable CS1573
	/// <summary>Extension methods to the <see cref="IWMCameraScannerDelegateObjC" /> interface to support all the methods from the WMCameraScannerDelegateObjC protocol.</summary>
	/// <remarks>
	///   <para>The extension methods for <see cref="IWMCameraScannerDelegateObjC" /> interface allow developers to treat instances of the interface as having all the optional methods of the original WMCameraScannerDelegateObjC protocol. Since the interface only contains the required members, these extension methods allow developers to call the optional members of the protocol.</para>
	/// </remarks>
...
namespace WaterMeter.Maui.Platforms.iOS {
	/// <summary>
	///   <para>This is a class that implements the interface <see cref="IWMCameraScannerDelegateObjC" /> (for the protocol <c>WMCameraScannerDelegateObjC</c>).</para>
	///   <para>Subclass this class to easily create a type that implements the protocol.</para>
	///   <para>An alternative is to create a subclass of <see cref="NSObject" /> and then implemented the interface <see cref="IWMCameraScannerDelegateObjC" />.</para>
	/// </summary>
	[Protocol()]
